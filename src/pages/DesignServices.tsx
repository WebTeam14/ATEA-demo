  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-foreground mb-6">Design Services</h1>
        <p className="text-muted-foreground text-lg leading-relaxed mb-8">
          Our comprehensive design services help bring your engineering visions to life.
        </p>
        <div className="grid md:grid-cols-2 gap-6">
          {["CAD Design", "3D Modeling", "Product Design", "Industrial Design"].map((service) => (
            <div key={service} className="bg-card rounded-lg p-6 shadow-md border-l-4 border-primary">
              <h3 className="text-xl font-semibold text-foreground mb-2">{service}</h3>
              <p className="text-muted-foreground">Professional {service.toLowerCase()} solutions tailored to your needs.</p>
            </div>
          ))}
        </div>
      </main>
