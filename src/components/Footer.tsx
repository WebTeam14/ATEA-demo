      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { title: "5 axis Horiizontal Machining Center", path: "/ATEA-demo/design-services?section=horizontal" },
                { title: "Machine shop", path: "/ATEA-demo/consulting" },
                { title: "NABL Approved Metal Testing Lab", path: "/ATEA-demo/project-management" },
                { title: "Skill development Training Center", path: "/ATEA-demo/skill-development" },
                { title: "Hot Dip Galvanising Services", path: "/ATEA-demo/design-services?section=galvanizing" },
                { title: "Zinc Flaking Coating Services", path: "/ATEA-demo/design-services?section=zinc-flake" },
                { title: "Powder coating Services", path: "/ATEA-demo/design-services?section=powder-coating" },
                { title: "Shot blasting Services", path: "/ATEA-demo/design-services?section=shot-blasting" },
                { title: "EPOXY PAINT Services", path: "/ATEA-demo/design-services?section=epoxy-paint" },
                { title: "CED Phosphating Services", path: "/ATEA-demo/design-services?section=ced-phosphating" }
              ].map((service) => (
